...
public class CadastroCidadeService {
	...
	public void excluir(Long cidadeId) {
		try {
			...
			throw new EntidadeNaoEncontradaException(String.format(MSG_CIDADE_NAO_ECONTRADA, cidadeId));
	...
	public Cidade buscarOuFalhar(Long cidadeId) {
		return cidadeRepository.findById(cidadeId).orElseThrow(
				() -> new EntidadeNaoEncontradaException(String.format(MSG_CIDADE_NAO_ECONTRADA, cidadeId)));
	}
}
